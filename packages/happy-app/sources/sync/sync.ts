...
class Sync {
    ...
    private registerPushToken = async () => {
        ...
        // This bypasses Expo's push relay so we can send FCM notifications directly
    ...
    private handleUpdate = async (update: unknown) => {
        ...
        if (updateData.body.t === 'new-message') {
            ...
            // Friends feature removed – ignore relationship updates
            log.log('👥 Received relationship-updated update (ignored – friends removed)');
            ...
            // Feed feature removed – ignore feed updates
            log.log('📰 Received new-feed-post update (ignored – feed removed)');
        }
    }
