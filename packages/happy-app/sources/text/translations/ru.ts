...
export const ru: TranslationStructure = {
    ...
    server: {
        ...
        lanUrlLabel: 'URL локальной сети',
        lanUrlPlaceholder: 'http://192.168.1.100:3000',
        lanUrlFooter: 'Если сервер находится в той же сети и публичный URL недоступен (hairpin NAT), введите LAN-адрес здесь. Приложение автоматически использует тот URL, который ответит первым.',
        connectedViaLan: 'Подключено через локальную сеть',
        connectedViaPublic: 'Подключено через публичный URL',
    },
